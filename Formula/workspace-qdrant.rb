...
class WorkspaceQdrant < Formula
  ...
  def install
    ...
    # Install shell completions if available in the release archive
  ...
  def caveats
    <<~EOS
      ...
      For MCP server integration with Claude, see:
        https://github.com/ChrisGVE/workspace-qdrant-mcp/blob/main/docs/quick-start.md
    EOS
  end
